...
const styles = StyleSheet.create({ overlay: { flex: 1, justifyContent: "center", alignItems: "center", paddingHorizontal: 24, backgroundColor: "rgba(0,0,0,0.24)" }, dialog: { width: "100%", maxWidth: 360, borderWidth: 1, borderRadius: 22, padding: 16, gap: 10, elevation: 12 }, header: { flexDirection: "row", alignItems: "center", gap: 12 }, close: { width: 36, height: 36, borderRadius: 18, alignItems: "center", justifyContent: "center" }, copy: { flex: 1, alignItems: "flex-end" }, title: { fontSize: 16, fontWeight: "800" as any, textAlign: "right" }, description: { marginTop: 3, fontSize: 11, textAlign: "right" }, divider: { height: StyleSheet.hairlineWidth }, action: { minHeight: 56, flexDirection: "row-reverse", alignItems: "center", gap: 10, borderWidth: 1, borderRadius: 14, paddingHorizontal: 10 }, actionIcon: { width: 36, height: 36, borderRadius: 11, alignItems: "center", justifyContent: "center" }, actionText: { flex: 1, textAlign: "right", fontSize: 13, fontWeight: "700" as any } });
