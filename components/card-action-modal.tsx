...
const styles = StyleSheet.create({ overlay: { flex: 1, justifyContent: "center", alignItems: "center", paddingHorizontal: 24, backgroundColor: "rgba(0,0,0,0.24)" }, dialog: { width: "100%", maxWidth: 360, borderWidth: 1, borderRadius: DESIGN.radius.xl, padding: DESIGN.spacing.lg, gap: DESIGN.spacing.md, elevation: 12 }, header: { flexDirection: "row", alignItems: "center", gap: 12 }, close: { width: DESIGN.control.compact, height: DESIGN.control.compact, borderRadius: DESIGN.radius.pill, alignItems: "center", justifyContent: "center" }, copy: { flex: 1, alignItems: "flex-start" }, title: { fontSize: 16, fontWeight: "800" as any, textAlign: "left" }, description: { marginTop: 3, fontSize: 11, textAlign: "left" }, divider: { height: StyleSheet.hairlineWidth }, action: { minHeight: DESIGN.control.large, flexDirection: "row", alignItems: "center", gap: 10, borderWidth: 1, borderRadius: DESIGN.radius.md, paddingHorizontal: DESIGN.spacing.sm }, actionIcon: { width: DESIGN.control.compact, height: DESIGN.control.compact, borderRadius: DESIGN.radius.sm, alignItems: "center", justifyContent: "center" }, actionText: { flex: 1, textAlign: "left", fontSize: 13, fontWeight: "700" as any } });
