...
const styles = StyleSheet.create({
  backdrop: { flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(15, 23, 42, 0.42)" }, sheet: { maxHeight: "88%", borderTopLeftRadius: 24, borderTopRightRadius: 24, borderWidth: 1, overflow: "hidden" }, header: { minHeight: 76, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 10, borderBottomWidth: 1 }, headerButton: { width: 38, height: 38, borderRadius: 19, alignItems: "center", justifyContent: "center" }, headerIcon: { width: 42, height: 42, borderRadius: 14, alignItems: "center", justifyContent: "center" }, headerCopy: { flex: 1, alignItems: "flex-end" }, title: { fontSize: 17, fontWeight: "800" as const, textAlign: "right" }, subtitle: { fontSize: 10, textAlign: "right", marginTop: 3 }, content: { padding: 16, paddingBottom: 22, gap: 18 }, notice: { flexDirection: "row", alignItems: "center", gap: 8, borderWidth: 1, borderRadius: 13, padding: 11 }, noticeText: { flex: 1, fontSize: 11, lineHeight: 18, textAlign: "right" }, previewCard: { borderWidth: 1, borderRadius: 16, padding: 12, gap: 8 }, previewHeader: { flexDirection: "row", alignItems: "center", gap: 9 }, previewIcon: { width: 34, height: 34, borderRadius: 11, alignItems: "center", justifyContent: "center" }, previewCopy: { flex: 1, alignItems: "flex-end" }, previewTitle: { fontSize: 13, fontWeight: "800" as const, textAlign: "right" }, previewHint: { fontSize: 9, textAlign: "right", marginTop: 2 }, previewLabel: { fontSize: 10, fontWeight: "700" as const, textAlign: "right", marginTop: 4 }, miniTable: { overflow: "hidden", borderWidth: 1, borderRadius: 10 }, miniTableHeader: { minHeight: 28, paddingHorizontal: 9, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, miniTableHeaderText: { color: "#fff", fontSize: 10, fontWeight: "800" as const }, miniTableRow: { minHeight: 26, paddingHorizontal: 9, flexDirection: "row", justifyContent: "space-between", alignItems: "center", borderTopWidth: StyleSheet.hairlineWidth }, miniTableText: { fontSize: 10, fontWeight: "600" as const }, miniChart: { minHeight: 74, justifyContent: "flex-end", borderWidth: 1 }, chartBars: { height: 48, flexDirection: "row", alignItems: "flex-end", justifyContent: "space-evenly", gap: 8 }, chartBar: { width: 14, minHeight: 5, borderTopLeftRadius: 4, borderTopRightRadius: 4 }, chartBaseline: { height: 1, width: "100%", marginTop: 3 }, group: { gap: 8 }, groupTitle: { fontSize: 14, fontWeight: "800" as const, textAlign: "right" }, choice: { minHeight: 58, borderWidth: 1, borderRadius: 13, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", gap: 10 }, choiceCopy: { flex: 1, alignItems: "flex-end" }, choiceTitle: { fontSize: 13, fontWeight: "700" as const, textAlign: "right" }, choiceHint: { fontSize: 10, textAlign: "right", marginTop: 2 }, colorGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, colorOption: { width: "31%", minHeight: 69, borderWidth: 1, borderRadius: 13, justifyContent: "center", alignItems: "center", gap: 5 }, colorSwatch: { width: 25, height: 25, borderRadius: 13, alignItems: "center", justifyContent: "center" }, colorLabel: { fontSize: 10, fontWeight: "700" as const }, footer: { flexDirection: "row", gap: 10, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 20, borderTopWidth: 1 }, resetButton: { flex: 1, minHeight: 48, borderWidth: 1, borderRadius: 13, alignItems: "center", justifyContent: "center" }, resetText: { fontSize: 13, fontWeight: "700" as const }, saveButton: { flex: 1.3, minHeight: 48, borderRadius: 13, alignItems: "center", justifyContent: "center" }, saveText: { color: "#fff", fontSize: 13, fontWeight: "800" as const },
});
