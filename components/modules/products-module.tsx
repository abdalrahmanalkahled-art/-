...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: "row", alignItems: "center", justifyContent: "flex-start", padding: 16, borderBottomWidth: 0.5 },
  ...
  categoryHeader: { flexDirection: "row", alignItems: "center", justifyContent: "flex-start", padding: 14, gap: 12 },
  categoryTitle: { fontSize: 16, fontWeight: "700" as any, flex: 1, textAlign: "left" },
  ...
  productItem: { flexDirection: "row", alignItems: "center", justifyContent: "flex-start", padding: 12, gap: 12, borderBottomWidth: 1 },
  ...
  categoryListItemText: { fontSize: 14, fontWeight: "500" as any, flex: 1, textAlign: "left", marginRight: 12 },
