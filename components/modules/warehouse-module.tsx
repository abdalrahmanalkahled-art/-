...
const styles = StyleSheet.create({
  ...
  movementItem: { fontSize: 14, fontWeight: "600" as any, textAlign: "left" },
  movementDate: { fontSize: 12, textAlign: "left" },
  movementNotes: { fontSize: 11, textAlign: "left" },
  movementLeft: { alignItems: "flex-start" },
  ...
  categoryDropdown: { borderRadius: 10, borderWidth: 1 },
  ...
  movTypeBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: "#E5E7EB", alignItems: "center" },
  movTypeBtnText: { fontSize: 14, fontWeight: "600" as any },
  itemSelector: { maxHeight: 150, borderWidth: 1, borderRadius: 10, borderColor: "#E5E7EB" },
  ...
  footerBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, alignItems: 'center', borderWidth: 1 },
