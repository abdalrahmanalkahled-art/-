...
const styles = StyleSheet.create({
  ...
  notificationHeaderCopy: { flex: 1, alignItems: "flex-start" },
  notificationTitle: { fontSize: 16, fontWeight: "800" as any, textAlign: "left" },
  notificationHint: { fontSize: 10, marginTop: 3, textAlign: "left" },
  ...
  notificationItemTitle: { fontSize: 12, fontWeight: "800" as any, textAlign: "left" },
  notificationItemDescription: { fontSize: 10, lineHeight: 16, textAlign: "left" },
  ...
  contractAlertCopy: { flex: 1, alignItems: "flex-start" },
  contractAlertTitle: { fontSize: 11, fontWeight: "800" as any, textAlign: "left" },
  contractAlertText: { fontSize: 10, marginTop: 3, textAlign: "left" },
  ...
  roadContractCopy: { flex: 1, alignItems: "flex-start" },
  roadContractTitleRow: { width: "100%", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 8 },
  roadContractTitle: { flex: 1, fontSize: 14, fontWeight: "800" as any, textAlign: "left" },
  roadContractMeta: { fontSize: 10, marginTop: 5, textAlign: "left" },
  roadContractRatings: { fontSize: 10, marginTop: 4, textAlign: "left", fontWeight: "700" as any },
  roadContractHint: { fontSize: 9, marginTop: 4, textAlign: "left" },
  ...
  contractStatusText: { fontSize: 8, fontWeight: "700" as any, textAlign: "left", flexShrink: 1 },
  ...
  detailsHeroCopy: { flex: 1, alignItems: "flex-start" },
  ...
  detailsHeroDescription: { color: "rgba(255,255,255,0.86)", fontSize: 11, marginTop: 4, textAlign: "left" },
  ...
  exportPanelCopy: { flex: 1, alignItems: "flex-start" },
  exportPanelTitle: { fontSize: 15, fontWeight: "800" as any },
  exportPanelDescription: { fontSize: 11, marginTop: 3, textAlign: "left" },
  ...
  dropdownItemText: { fontSize: 14, textAlign: "left" },
  ...
  infoValue: { fontSize: 14, textAlign: "left", flex: 1, marginLeft: 12 },
  ...
  renewTitle: { fontSize: 16, fontWeight: "800" as any, textAlign: "left" },
  ...
  signageFabWrap: { position: "absolute", right: 18, bottom: 20, alignItems: "flex-start", gap: 10, zIndex: 100 },
  ...
  signageFabHeader: { fontSize: 10, fontWeight: "800" as any, paddingHorizontal: 13, paddingTop: 6, paddingBottom: 3, textAlign: "left" },
  signageFabItem: { minHeight: 43, paddingHorizontal: 13, flexDirection: "row", alignItems: "center", gap: 8 },
  signageFabItemText: { fontSize: 12, fontWeight: "800" as any, flex: 1, textAlign: "left" },
