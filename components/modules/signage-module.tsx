...
const styles = StyleSheet.create({
  ...
  notificationHeader: { minHeight: 66, paddingHorizontal: 14, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  ...
  notificationItem: { minHeight: 70, borderWidth: 1, borderRadius: 14, padding: 10, flexDirection: "row-reverse", alignItems: "center", gap: 9 },
  ...
  contractAlert: { minHeight: 58, borderWidth: 1, borderRadius: 14, paddingHorizontal: 12, flexDirection: "row-reverse", gap: 8, alignItems: "center" },
  ...
  roadContractCard: { minHeight: 102, borderRadius: 16, padding: 13, borderWidth: 1, flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  ...
  roadContractTitleRow: { width: "100%", flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "flex-start", gap: 8 },
  ...
  contractStatus: { borderRadius: 8, paddingHorizontal: 6, paddingVertical: 3, flexDirection: "row-reverse", alignItems: "center", gap: 4, maxWidth: 170 },
  ...
  detailsHeroTop: { flexDirection: "row-reverse", alignItems: "center", gap: 12 },
  ...
  detailsMetrics: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", marginTop: 18, paddingTop: 14, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.22)" },
  ...
  exportPanelHeading: { flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  ...
  exportActions: { flexDirection: "row-reverse", gap: 10, marginTop: 14 },
  exportAction: { flex: 1, minHeight: 48, borderRadius: 14, alignItems: "center", justifyContent: "center", flexDirection: "row-reverse", gap: 7 },
  ...
  detailsHeading: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", marginBottom: 10 },
  ...
  renewOption: { minHeight: 49, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between" },
  ...
  signageFabItem: { minHeight: 43, paddingHorizontal: 13, flexDirection: "row-reverse", alignItems: "center", gap: 8 },
