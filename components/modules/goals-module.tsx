...
const styles = StyleSheet.create({
  ...
  goalHeader: { flexDirection: "row", alignItems: "center", justifyContent: "flex-start", gap: 8, flexWrap: "wrap" },
  goalTitle: { fontSize: 15, fontWeight: "700" as any, textAlign: "left" },
  ...
  kpiText: { fontSize: 12, textAlign: "left" },
  brandBadge: { flexDirection: "row", alignSelf: "flex-start", alignItems: "center", gap: 5, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4 },
  brandBadgeText: { fontSize: 11, fontWeight: "600" as any },
  tasksSection: { gap: 6 },
  tasksTitle: { fontSize: 13, fontWeight: "600" as any, textAlign: "left" },
  taskItem: { flexDirection: "row", alignItems: "center", justifyContent: "flex-start", gap: 8, padding: 8, borderLeftWidth: 3, borderRadius: 4, backgroundColor: "rgba(0,0,0,0.03)" },
  taskTitle: { fontSize: 13, flex: 1, textAlign: "left" },
  ...
  brandPickerText: { flex: 1, textAlign: "left", fontSize: 15 },
  ...
  brandOptionText: { fontSize: 13, fontWeight: "500" as any, textAlign: "left" },
  brandEmptyText: { fontSize: 12, textAlign: "left", padding: 12 },
  ...
  modalFooter: { flexDirection: "row", gap: 12, padding: 16, borderTopWidth: 0.5, justifyContent: "flex-start" },
