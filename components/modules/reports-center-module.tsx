...
const styles = StyleSheet.create({
  ...
  header: { alignItems: "center", borderBottomWidth: 1, flexDirection: "row-reverse", justifyContent: "space-between", paddingBottom: 12 },
  title: { fontSize: 18, fontWeight: "700" },
  refreshButton: { padding: 6 },
  headerAction: { minWidth: 48, padding: 6 },
  headerActionText: { fontSize: 13, fontWeight: "700", textAlign: "right" },
  selectionActions: { flexDirection: "row-reverse", alignItems: "center", gap: 6 },
  headerIcon: { padding: 6 },
  disabled: { opacity: 0.4 },
  description: { fontSize: 13, lineHeight: 20, paddingVertical: 12, textAlign: "right" },
  ...
  cardTop: { alignItems: "center", flexDirection: "row-reverse", gap: 10 },
  typeBadge: { borderRadius: 6, paddingHorizontal: 8, paddingVertical: 4 },
  typeText: { fontSize: 12, fontWeight: "700" },
  cardTitle: { flex: 1, fontSize: 14, fontWeight: "600", textAlign: "right" },
  cardMeta: { fontSize: 12, textAlign: "right" },
  actions: { flexDirection: "row-reverse", gap: 8, marginTop: 4 },
  shareButton: { alignItems: "center", borderRadius: 8, flexDirection: "row-reverse", gap: 5, paddingHorizontal: 12, paddingVertical: 8 },
  shareText: { color: "#fff", fontSize: 13, fontWeight: "600" },
  deleteButton: { alignItems: "center", borderRadius: 8, borderWidth: 1, flexDirection: "row-reverse", gap: 5, paddingHorizontal: 12, paddingVertical: 8 },
