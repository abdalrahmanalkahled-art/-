...
const styles = StyleSheet.create({
  ...
  expenseCard: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderRadius: 12, padding: 12, borderWidth: 1 }, expenseRight: { flexDirection: "row", alignItems: "center", gap: 10, flex: 1 }, expenseText: { flex: 1 }, catIcon: { width: 34, height: 34, borderRadius: 10, alignItems: "center", justifyContent: "center" }, expenseTitle: { fontSize: 14, fontWeight: "600" as any, textAlign: "left" }, expenseMeta: { fontSize: 11, marginTop: 2, textAlign: "left" }, expenseAmount: { fontSize: 15, fontWeight: "700" as any, marginHorizontal: 8 }, deleteBtn: { padding: 4 },
  empty: { alignItems: "center", paddingVertical: 40, gap: 8 }, emptyText: { fontSize: 14 }, modal: { flex: 1 }, modalHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 16, borderBottomWidth: 0.5 }, modalTitle: { fontSize: 17, fontWeight: "700" as any }, modalContent: { flex: 1, padding: 16 }, formGroup: { marginBottom: 16 }, formLabel: { fontSize: 14, fontWeight: "600" as any, marginBottom: 8, textAlign: "left" }, formInput: { borderWidth: 1, borderRadius: 10, padding: 12, fontSize: 15 }, datePickerButton: { minHeight: 48, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, datePickerText: { fontSize: 15, fontWeight: "600" as any }, textArea: { height: 80 },
