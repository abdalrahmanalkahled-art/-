...
import { ActivityIndicator, Animated, Easing, FlatList, Keyboard, Modal, Platform, Share, StyleSheet, Text, TextInput, TouchableOpacity, View } from "react-native";
...
export default function AIChatModule() {
  ...
  useEffect(() => {
    ...
    const showSubscription = Keyboard.addListener(showEvent, (event) => setKeyboardHeight(Math.max(0, event.endCoordinates.height - insets.bottom)));
