...
export default function AIChatModule() {
  ...
  return (
    <View style={styles.container}>
      ...
      <KeyboardAvoidingView style={styles.composerKeyboard} behavior={Platform.OS === "ios" ? "padding" : "height"} keyboardVerticalOffset={Platform.OS === "ios" ? insets.bottom + 8 : 0} enabled><View style={[styles.composer, { borderColor: colors.border, backgroundColor: colors.background }]}>
