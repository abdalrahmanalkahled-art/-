  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? "padding" : "height"} keyboardVerticalOffset={Platform.OS === "ios" ? 8 : 0}>
      <View style={[styles.toolbar, { borderBottomColor: colors.border }]}>
        <TouchableOpacity accessibilityRole="button" accessibilityLabel="فتح النطاق والأرشيف" style={[styles.menuButton, { backgroundColor: colors.primary + "12", borderColor: colors.primary + "22" }]} onPress={() => setDrawerVisible(true)} activeOpacity={0.75}>
