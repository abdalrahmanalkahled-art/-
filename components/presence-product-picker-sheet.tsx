...
const styles = StyleSheet.create({
  backdrop: { flex: 1, justifyContent: "flex-start", backgroundColor: "rgba(15, 23, 42, 0.44)" },
  ...
  subtitle: { fontSize: 11, textAlign: "left", marginTop: 3 },
  ...
  resultsLabel: { fontSize: 11, textAlign: "left", marginTop: 12, marginBottom: 4 },
  list: { flexGrow: 0 },
  ...
  productName: { flex: 1, fontSize: 14, fontWeight: "700" as any, textAlign: "left", writingDirection: "rtl" },
