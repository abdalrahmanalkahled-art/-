...
const styles = StyleSheet.create({ root: { flex: 1 }, list: { padding: 12, gap: 10 }, emptyList: { flexGrow: 1 }, empty: { alignItems: "center", justifyContent: "center", padding: 48, gap: 8 }, emptyTitle: { fontSize: 16, fontWeight: "800" }, emptyText: { textAlign: "center", fontSize: 12, lineHeight: 19 }, card: { borderWidth: 1, borderRadius: 17, padding: 12, gap: 10 }, topRow: { flexDirection: "row-reverse", alignItems: "center", gap: 10 }, image: { width: 52, height: 52, borderRadius: 13 }, icon: { width: 52, height: 52, borderRadius: 13, alignItems: "center", justifyContent: "center" }, copy: { flex: 1, gap: 4 }, name: { textAlign: "right", fontWeight: "800", fontSize: 15 }, quantity: { textAlign: "right", fontSize: 12 }, actions: { flexDirection: "row-reverse", gap: 6 }, iconButton: { width: 34, height: 34, borderRadius: 10, alignItems: "center", justifyContent: "center" }, metaRow: { flexDirection: "row-reverse", alignItems: "center", gap: 8 }, condition: { paddingHorizontal: 8, minHeight: 28, borderRadius: 14, flexDirection: "row-reverse", alignItems: "center", gap: 4 }, conditionText: { fontSize: 10, fontWeight: "800" }, brands: { flex: 1, textAlign: "right", fontSize: 11 }, modalRoot: { flex: 1 }, modalHeader: { minHeight: 58, paddingHorizontal: 16, borderBottomWidth: 1, flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between" }, modalTitle: { fontSize: 17, fontWeight: "800" }, form: { padding: 16, gap: 10, paddingBottom: 28 }, label: { textAlign: "right", fontWeight: "700", fontSize: 13, marginTop: 2 }, input: { borderWidth: 1, borderRadius: 12, minHeight: 48, paddingHorizontal: 12, fontSize: 15 }, modeRow: { flexDirection: "row-reverse", gap: 8 }, mode: { flex: 1, minHeight: 42, alignItems: "center", justifyContent: "center", borderWidth: 1, borderRadius: 11 }, help: { textAlign: "right", fontSize: 11, lineHeight: 17 }, brandList: { borderWidth: 1, borderRadius: 12, maxHeight: 165 }, brandListContent: { paddingBottom: 1 }, brandRow: { minHeight: 43, borderBottomWidth: 1, flexDirection: "row-reverse", alignItems: "center", gap: 9, paddingHorizontal: 10 }, brandName: { flex: 1, textAlign: "right", fontWeight: "600", fontSize: 13 }, conditions: { flexDirection: "row-reverse", gap: 7 }, conditionOption: { flex: 1, minHeight: 46, paddingHorizontal: 5, borderWidth: 1, borderRadius: 11, alignItems: "center", justifyContent: "center", gap: 3 }, preview: { width: "100%", height: 160, borderRadius: 13 }, imageActions: { flexDirection: "row-reverse", gap: 8 }, imageButton: { minHeight: 42, paddingHorizontal: 12, borderWidth: 1, borderRadius: 11, flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 6 }, imageButtonText: { fontSize: 12, fontWeight: "800" }, footer: { padding: 14, borderTopWidth: 1, flexDirection: "row-reverse", gap: 10 }, footerButton: { flex: 1, minHeight: 46, borderRadius: 12, borderWidth: 1, alignItems: "center", justifyContent: "center" } });
