...
const styles = StyleSheet.create({
  ...
  head: { flexDirection: "row", gap: 10, alignItems: "flex-start" }, iconButton: { width: 34, height: 34, borderRadius: 17, alignItems: "center", justifyContent: "center" }, headCopy: { flex: 1, gap: 3 }, title: { fontSize: 16, fontWeight: "800", textAlign: "right" }, hint: { fontSize: 11, lineHeight: 17, textAlign: "right" },
  actions: { marginTop: 12, marginBottom: 8, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, clearButton: { minHeight: 36, borderWidth: 1, borderRadius: 18, paddingHorizontal: 11, flexDirection: "row", alignItems: "center", gap: 5 }, clearText: { fontSize: 11, fontWeight: "800" }, count: { fontSize: 11, fontWeight: "700" }, list: { paddingBottom: 6, gap: 7 },
  audience: { minHeight: 34, borderRadius: 10, marginTop: 6, paddingHorizontal: 10, flexDirection: "row", alignItems: "center", gap: 6 }, audienceText: { fontSize: 12, fontWeight: "800" }, categoryHead: { minHeight: 58, marginTop: 7, paddingHorizontal: 10, borderWidth: 1, borderRadius: 12, flexDirection: "row", alignItems: "center", gap: 8 }, categoryCopy: { flex: 1, gap: 2 }, categoryTitle: { fontSize: 13, fontWeight: "800", textAlign: "right" }, categoryHint: { fontSize: 10, textAlign: "right" }, categoryAction: { minHeight: 31, borderWidth: 1, borderRadius: 9, paddingHorizontal: 8, flexDirection: "row", alignItems: "center", gap: 4 }, categoryActionText: { fontSize: 10, fontWeight: "800" },
  product: { minHeight: 50, marginHorizontal: 5, paddingHorizontal: 9, borderBottomWidth: 1, flexDirection: "row", alignItems: "center", gap: 9 }, productCopy: { flex: 1, gap: 2 }, productName: { fontSize: 12, fontWeight: "700", textAlign: "right" }, productBrand: { fontSize: 10, textAlign: "right" }, empty: { textAlign: "center", paddingVertical: 30, fontSize: 12 },
});
