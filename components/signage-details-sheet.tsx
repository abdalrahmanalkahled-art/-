...
const styles = StyleSheet.create({
  ...
  storeContractCopy: { flex: 1, alignItems: "flex-start" },
  storeContractTitle: { fontSize: 17, fontWeight: "800" as any, textAlign: "left" },
  storeContractSubtitle: { fontSize: 11, marginTop: 3, textAlign: "left" },
  ...
  secondaryImageLabel: { padding: 12, textAlign: "left", fontWeight: "700" as any, fontSize: 13 },
  ...
  brandHistoryCopy: { flex: 1, alignItems: "flex-start" },
  ...
  maintenanceMeta: { alignItems: "flex-start" },
