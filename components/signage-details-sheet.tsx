...
const styles = StyleSheet.create({
  ...
  storeContractTop: { flexDirection: "row-reverse", alignItems: "center", gap: 9 },
  ...
  storeMetrics: { flexDirection: "row-reverse", alignItems: "center", marginTop: 14, paddingTop: 12, borderTopWidth: StyleSheet.hairlineWidth },
  ...
  brandHistoryRow: { minHeight: 48, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", marginTop: 10, paddingTop: 10 },
