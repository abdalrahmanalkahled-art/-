...
const styles = StyleSheet.create({ card: { borderRadius: 18, borderWidth: 1, padding: 14 }, title: { fontSize: 15, fontWeight: "800", textAlign: "left" }, caption: { fontSize: 11, textAlign: "left", marginTop: 4, marginBottom: 8 }, scrollContent: { paddingBottom: 4 }, chartCanvas: { position: "relative" }, labels: { flexDirection: "row", justifyContent: "space-between", paddingHorizontal: 4 }, label: { width: 82, fontSize: 9, textAlign: "center", lineHeight: 13 }, productAxisLabel: { fontWeight: "700" }, horizontalLabels: { position: "absolute", top: 0, left: 0, bottom: 0 }, horizontalLabel: { position: "absolute", right: 0, fontSize: 9, lineHeight: 18, textAlign: "left", fontWeight: "700" }, legend: { flexDirection: "row", flexWrap: "wrap", gap: 9, marginTop: 8 }, legendItem: { flexDirection: "row", alignItems: "center", gap: 5 }, dot: { width: 9, height: 9, borderRadius: 5 }, legendText: { fontSize: 10 }, emptyCard: { borderRadius: 18, borderWidth: 1, padding: 22 }, emptyText: { textAlign: "center", lineHeight: 20, fontSize: 13 } });
