...
const styles = StyleSheet.create({
  container: { gap: 12 },
  group: { gap: 8 },
  heading: { minHeight: 76, borderWidth: 1, borderRadius: 16, padding: 10, flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  headingCopy: { flex: 1, gap: 4 },
  categoryLabel: { textAlign: "right", fontSize: 14, fontWeight: "800" },
  scope: { textAlign: "right", fontSize: 10 },
  sourceAverages: { flexDirection: "row-reverse", gap: 6 },
  ...
  helpTrigger: { minHeight: 38, borderWidth: 1, borderRadius: 12, paddingHorizontal: 11, flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 6 },
  ...
  helpHeader: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between" },
