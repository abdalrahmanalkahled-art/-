...
const styles = StyleSheet.create({
  ...
  categoryLabel: { textAlign: "left", fontSize: 14, fontWeight: "800" },
  scope: { textAlign: "left", fontSize: 10 },
  ...
  helpTitle: { fontSize: 15, fontWeight: "800", textAlign: "left" },
  helpText: { fontSize: 12, lineHeight: 19, textAlign: "left" },
