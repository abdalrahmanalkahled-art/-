...
const styles = StyleSheet.create({
  ...
  heroTitle: { color: "#fff", textAlign: "left", fontSize: 23, fontWeight: "800", lineHeight: 30, marginTop: 16 },
  ...
  cardTitle: { textAlign: "left", fontSize: 16, fontWeight: "800", marginBottom: 12 },
  ...
  goalTextGroup: { flex: 1, alignItems: "flex-start" },
  goalLabel: { fontSize: 11, fontWeight: "600", marginBottom: 3 },
  goalTitle: { textAlign: "left", fontSize: 14, fontWeight: "800" },
  ...
  statusSummaryCopy: { flex: 1, alignItems: "flex-start" },
  ...
  documentationSubtitle: { fontSize: 11, textAlign: "left", marginTop: -7, marginBottom: 14 },
  ...
  notesText: { textAlign: "left", fontSize: 14, lineHeight: 22 },
});
