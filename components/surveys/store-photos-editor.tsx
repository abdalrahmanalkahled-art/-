...
const styles = StyleSheet.create({ section: { borderWidth: 1, borderRadius: 16, padding: 12, gap: 10 }, header: { flexDirection: "row", alignItems: "center", gap: 8 }, title: { fontSize: 15, fontWeight: "800" }, hint: { fontSize: 11, lineHeight: 17, textAlign: "right" }, empty: { textAlign: "center", paddingVertical: 8, fontSize: 12 }, photoList: { flexDirection: "row", gap: 9 }, photoCard: { width: 116, borderWidth: 1, borderRadius: 12, overflow: "hidden" }, preview: { width: 114, height: 86 }, previewCaption: { minHeight: 31, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 4 }, previewCaptionText: { fontSize: 9, fontWeight: "700" }, action: { width: "100%", minHeight: 42, borderWidth: 1, borderRadius: 12, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 6 }, actionText: { fontSize: 12, fontWeight: "800" }, viewerBackdrop: { flex: 1, justifyContent: "center", padding: 16, backgroundColor: "#00000088" }, viewer: { width: "100%", borderRadius: 20, padding: 14 }, viewerHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }, close: { width: 36, height: 36, borderRadius: 18, alignItems: "center", justifyContent: "center" }, viewerTitle: { fontSize: 16, fontWeight: "800" }, fullImage: { width: "100%", height: 330, borderRadius: 13, backgroundColor: "#000" }, viewerActions: { flexDirection: "row", gap: 8, marginTop: 12 }, viewerAction: { flex: 1, minHeight: 51, borderWidth: 1, borderRadius: 13, alignItems: "center", justifyContent: "center", gap: 2 }, viewerActionText: { fontSize: 11, fontWeight: "800" }, editing: { position: "absolute", inset: 0, borderRadius: 20, backgroundColor: "#ffffffd9", alignItems: "center", justifyContent: "center", gap: 9 }, editingText: { fontSize: 12, fontWeight: "700" } });
