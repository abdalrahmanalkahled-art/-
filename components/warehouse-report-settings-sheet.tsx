...
const styles = StyleSheet.create({
  sheet: { flex: 1 }, header: { minHeight: 76, paddingHorizontal: 16, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: "row", alignItems: "center", gap: 11 }, close: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerText: { flex: 1, alignItems: "flex-start" }, title: { fontSize: 16, fontWeight: "800" as any }, subtitle: { fontSize: 11, marginTop: 3 }, headerIcon: { width: 40, height: 40, borderRadius: 13, alignItems: "center", justifyContent: "center" }, content: { padding: 16, paddingBottom: 22 }, sectionLabel: { fontSize: 11, fontWeight: "800" as any, textAlign: "left", marginBottom: 7 }, sectionBox: { borderWidth: 1, borderRadius: 16, paddingHorizontal: 12 }, row: { minHeight: 69, flexDirection: "row", alignItems: "center", gap: 11 }, copy: { flex: 1, alignItems: "flex-start" }, rowTitle: { fontSize: 14, fontWeight: "800" as any, textAlign: "left" }, rowSubtitle: { fontSize: 11, lineHeight: 16, marginTop: 3, textAlign: "left" }, columnGroup: { marginTop: 19 }, columnHeader: { alignItems: "flex-start", marginBottom: 8 }, columnTitle: { fontSize: 14, fontWeight: "800" as any, textAlign: "left" }, columnHint: { fontSize: 10, marginTop: 2, textAlign: "left" }, columnList: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, columnOption: { minHeight: 39, paddingHorizontal: 10, borderWidth: 1, borderRadius: 12, flexDirection: "row", alignItems: "center", gap: 6 }, check: { width: 19, height: 19, borderWidth: 1, borderRadius: 6, alignItems: "center", justifyContent: "center" }, columnText: { fontSize: 12, fontWeight: "700" as any }, imageRow: { marginTop: 18, minHeight: 78, paddingHorizontal: 12, borderWidth: 1, borderRadius: 15, flexDirection: "row", alignItems: "center", gap: 11 }, footer: { padding: 14, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: "row", gap: 10 }, cancel: { flex: .8, minHeight: 48, borderWidth: 1, borderRadius: 14, alignItems: "center", justifyContent: "center" }, cancelText: { fontSize: 14, fontWeight: "700" as any }, save: { flex: 1.35, minHeight: 48, borderRadius: 14, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7 }, saveText: { color: "#fff", fontSize: 14, fontWeight: "800" as any },
});
