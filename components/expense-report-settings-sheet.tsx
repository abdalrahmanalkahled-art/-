...
const styles = StyleSheet.create({
  root: { flex: 1 }, header: { minHeight: 66, borderBottomWidth: 1, paddingHorizontal: 18, flexDirection: "row", alignItems: "center", gap: 12 }, headerCopy: { flex: 1, alignItems: "flex-end" }, headerTitle: { fontSize: 17, fontWeight: "800" }, headerSubtitle: { fontSize: 10, marginTop: 3, textAlign: "right" }, headerGap: { width: 24 }, content: { padding: 16, gap: 12, paddingBottom: 114 }, card: { borderWidth: 1, borderRadius: 18, padding: 14, gap: 10 }, title: { fontSize: 15, fontWeight: "800", textAlign: "right" }, hint: { fontSize: 11, lineHeight: 17, textAlign: "right" }, modeRow: { flexDirection: "row", gap: 9 }, modeOption: { flex: 1, minHeight: 48, borderWidth: 1, borderRadius: 12, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, paddingHorizontal: 8 }, modeText: { fontSize: 12, fontWeight: "800", textAlign: "center" }, dateRangeButton: { minHeight: 46, borderWidth: 1, borderRadius: 12, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7 }, dateRangeText: { fontSize: 12, fontWeight: "800" }, search: { minHeight: 46, borderWidth: 1, borderRadius: 12, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 11 }, searchInput: { flex: 1, fontSize: 13, paddingVertical: 8 }, selectionMeta: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, selectVisible: { minHeight: 34, paddingHorizontal: 10, borderRadius: 9, flexDirection: "row", alignItems: "center", gap: 5 }, selectVisibleText: { fontSize: 11, fontWeight: "800" }, selectionCount: { fontSize: 11, textAlign: "right" }, emptySearch: { minHeight: 82, borderWidth: 1, borderStyle: "dashed", borderRadius: 12, justifyContent: "center", alignItems: "center", gap: 5 }, emptyText: { fontSize: 11 }, setting: { minHeight: 66, borderWidth: 1, borderRadius: 13, flexDirection: "row", alignItems: "center", padding: 10, gap: 9 }, check: { width: 23, height: 23, borderWidth: 1.5, borderRadius: 7, alignItems: "center", justifyContent: "center" }, settingCopy: { flex: 1, alignItems: "flex-end", gap: 3 }, settingTitle: { fontSize: 12, fontWeight: "800", textAlign: "right" }, settingDescription: { fontSize: 10, lineHeight: 15, textAlign: "right" }, listLabel: { fontSize: 11, fontWeight: "800", textAlign: "right", marginTop: 2 }, categoryRow: { minHeight: 58, borderWidth: 1, borderRadius: 14, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", gap: 9 }, categoryIcon: { width: 34, height: 34, borderRadius: 10, alignItems: "center", justifyContent: "center" }, categoryLabel: { flex: 1, fontSize: 13, fontWeight: "800", textAlign: "right" }, bottomSpace: { height: 12 }, footer: { flexDirection: "row", gap: 10, padding: 15, borderTopWidth: 1 }, footerButton: { flex: 1, minHeight: 48, borderRadius: 12, alignItems: "center", justifyContent: "center" }, cancelText: { fontSize: 14, fontWeight: "800" }, saveText: { color: "#fff", fontSize: 14, fontWeight: "800" }, disabled: { opacity: 0.55 },
});
