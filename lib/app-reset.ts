...
export const APP_RESET_SCOPES: AppResetScope[] = [
  ...
  { id: "goals", title: "الخطة التسويقية", description: "الأهداف والفعاليات المرتبطة بها", warning: "سيُحذف كل هدف والفعاليات المرتبطة بالخطة حتى لا تبقى فعالية تشير إلى هدف غير موجود.", keys: [STORAGE_KEYS.MARKETING_GOALS, STORAGE_KEYS.EVENTS], directories: ["event_documentation/"] },
