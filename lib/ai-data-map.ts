...
const DATA_DOMAINS: DataDomain[] = [
  ...
  { id: "plan", title: "الخطة التسويقية والأهداف والمهام", keywords: ["خطة", "هدف", "أهداف", "تقدم", "kpi", "انتهاء", "منتهي", "مستهدف", "إنجاز", "مهمة"], keys: [STORAGE_KEYS.MARKETING_GOALS, STORAGE_KEYS.MARKETING_TASKS, STORAGE_KEYS.EVENTS, STORAGE_KEYS.BRANDS, STORAGE_KEYS.REGIONS], fields: {
    [STORAGE_KEYS.MARKETING_GOALS]: ["id", "title", "name", "description", "brandName", "region", "startDate", "endDate", "period", "kpi", "currentValue", "targetValue", "completionPercentage", "status", "tasks", "createdAt", "updatedAt"], [STORAGE_KEYS.MARKETING_TASKS]: ["id", "title", "name", "goalId", "goalName", "status", "dueDate", "createdAt", "updatedAt"], [STORAGE_KEYS.EVENTS]: ["id", "title", "eventDate", "region", "brandName", "status", "beneficiariesCount", "goalId", "createdAt", "updatedAt"], [STORAGE_KEYS.BRANDS]: ["id", "name", "isActive"], [STORAGE_KEYS.REGIONS]: ["id", "name", "isActive"],
  } },
