...
const styles = StyleSheet.create({
  header: { height: 76, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 12, borderBottomWidth: 1 }, back: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerCopy: { flex: 1, alignItems: "flex-end" }, headerTitle: { fontSize: 18, fontWeight: "800" as any }, headerSubtitle: { fontSize: 11, marginTop: 2, textAlign: "right" }, content: { padding: 16, paddingBottom: 105 }, summary: { minHeight: 100, borderRadius: 20, padding: 18, marginBottom: 14, flexDirection: "row-reverse", alignItems: "center", gap: 14, borderWidth: 1 }, summaryCopy: { flex: 1, alignItems: "flex-end" }, summaryValue: { color: "#fff", fontSize: 25, fontWeight: "900" as any }, summaryLabel: { color: "rgba(255,255,255,0.82)", fontSize: 11, marginTop: 4, textAlign: "right" }, gap: { height: 9 }, photoRow: { minHeight: 92, borderWidth: 1, borderRadius: 17, padding: 8, flexDirection: "row-reverse", alignItems: "center", gap: 10 }, photo: { width: 74, height: 74, borderRadius: 12, backgroundColor: "#E5E7EB" }, fileRow: { minHeight: 88, borderWidth: 1, borderRadius: 17, paddingHorizontal: 11, paddingVertical: 10, flexDirection: "row-reverse", alignItems: "center", gap: 10 }, fileIcon: { width: 46, height: 46, borderRadius: 14, alignItems: "center", justifyContent: "center" }, rowCopy: { flex: 1, alignItems: "flex-end" }, rowTitle: { fontSize: 13, fontWeight: "800" as any, textAlign: "right" }, rowSubtitle: { fontSize: 10, marginTop: 4, textAlign: "right" }, rowMeta: { fontSize: 10, marginTop: 4, textAlign: "right" }, iconButton: { width: 39, height: 39, borderRadius: 13, alignItems: "center", justifyContent: "center" }, backupActions: { gap: 7 }, check: { width: 25, height: 25, borderRadius: 8, borderWidth: 1.5, alignItems: "center", justifyContent: "center" }, empty: { minHeight: 210, borderRadius: 18, borderWidth: 1, alignItems: "center", justifyContent: "center", gap: 10, padding: 24 }, emptyText: { fontSize: 12, textAlign: "center" }, loading: { minHeight: 210, alignItems: "center", justifyContent: "center" }, selectionBar: { position: "absolute", left: 0, right: 0, bottom: 0, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 18, borderTopWidth: 1, flexDirection: "row-reverse", gap: 10 }, selectAllButton: { flex: 1, height: 48, borderRadius: 14, borderWidth: 1, alignItems: "center", justifyContent: "center" }, selectAllText: { fontSize: 13, fontWeight: "700" as any }, deleteSelectedButton: { flex: 1.25, height: 48, borderRadius: 14, flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 7 }, deleteSelectedText: { color: "#fff", fontSize: 13, fontWeight: "800" as any },
});
