...
const styles = StyleSheet.create({
  ...
  body: { flex: 1 }, searchBox: { margin: 14, minHeight: 54, borderWidth: 1, borderRadius: 17, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 10 }, input: { flex: 1, fontSize: 14, minHeight: 48 }, filters: { paddingHorizontal: 14, paddingBottom: 6, gap: 8, flexDirection: "row-reverse" }, filter: { minHeight: 36, borderRadius: 12, borderWidth: 1, paddingHorizontal: 13, alignItems: "center", justifyContent: "center" }, filterText: { fontSize: 12, fontWeight: "800" as const },
