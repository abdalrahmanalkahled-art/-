...
function SettingRow({ icon, title, subtitle, color, onPress, right }: SettingRowProps) {
  ...
  return <TouchableOpacity disabled={!onPress} onPress={onPress} activeOpacity={0.72} style={[styles.row, { borderBottomColor: colors.border, opacity: onPress || right ? 1 : 0.62 }]}>
    {right || (onPress ? <MaterialIcons name="chevron-right" size={21} color={colors.muted} /> : <View style={styles.rightSpacer} />)}
...
const styles = StyleSheet.create({
  header: { height: 76, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 12, borderBottomWidth: 1 }, backButton: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerText: { flex: 1, alignItems: "flex-start" }, headerTitle: { fontSize: 18, fontWeight: "800" as any }, headerSubtitle: { fontSize: 11, marginTop: 2 }, content: { padding: 16, paddingBottom: 38 }, sectionTitle: { fontSize: 12, fontWeight: "800" as any, textAlign: "left", marginTop: 12, marginBottom: 7, marginRight: 4 }, card: { borderWidth: 1, borderRadius: 16, overflow: "hidden" }, row: { minHeight: 67, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 11, borderBottomWidth: StyleSheet.hairlineWidth }, rightSpacer: { width: 21 }, rowBody: { flex: 1, alignItems: "flex-start" }, rowTitle: { fontSize: 14, fontWeight: "700" as any, textAlign: "left" }, rowSubtitle: { fontSize: 11, textAlign: "left", marginTop: 3 }, rowIcon: { width: 38, height: 38, borderRadius: 12, alignItems: "center", justifyContent: "center" },
  restorePreview: { borderWidth: 1, borderRadius: 16, padding: 14, marginTop: 10 }, previewHeader: { flexDirection: "row", alignItems: "center", gap: 10 }, previewIcon: { width: 40, height: 40, borderRadius: 13, alignItems: "center", justifyContent: "center" }, previewText: { flex: 1, alignItems: "flex-start" }, previewTitle: { fontSize: 14, fontWeight: "800" as any }, previewFile: { fontSize: 11, marginTop: 3, maxWidth: "100%" }, previewDate: { fontSize: 11, textAlign: "left", marginTop: 10 }, previewMetrics: { flexDirection: "row", justifyContent: "space-between", marginTop: 11 }, previewMetric: { fontSize: 11, fontWeight: "700" as any }, previewGroups: { fontSize: 11, textAlign: "left", lineHeight: 18, marginTop: 9 }, previewWarning: { fontSize: 11, textAlign: "left", lineHeight: 18, marginTop: 8 }, previewActions: { flexDirection: "row", gap: 9, marginTop: 13 }, previewCancel: { flex: 1, minHeight: 42, borderWidth: 1, borderRadius: 11, justifyContent: "center", alignItems: "center" }, previewCancelText: { fontSize: 13, fontWeight: "700" as any }, previewRestore: { flex: 1, minHeight: 42, borderRadius: 11, justifyContent: "center", alignItems: "center" }, previewRestoreText: { color: "#fff", fontSize: 13, fontWeight: "800" as any }, pickerOverlay: { flex: 1, justifyContent: "center", padding: 22, backgroundColor: "rgba(0,0,0,0.3)" }, reminderDialog: { borderWidth: 1, borderRadius: 22, padding: 16 }, reminderHeader: { flexDirection: "row", alignItems: "center", gap: 11, marginBottom: 12 }, reminderClose: { width: 36, height: 36, borderRadius: 18, alignItems: "center", justifyContent: "center" }, reminderCopy: { flex: 1, alignItems: "flex-start" }, reminderTitle: { fontSize: 16, fontWeight: "800" as any, textAlign: "left" }, reminderSubtitle: { fontSize: 10, textAlign: "left", marginTop: 3 }, reminderOption: { minHeight: 59, borderWidth: 1, borderRadius: 14, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", gap: 10, marginTop: 8 }, reminderRadio: { width: 20, height: 20, borderRadius: 10, borderWidth: 2, alignItems: "center", justifyContent: "center" }, reminderRadioDot: { width: 10, height: 10, borderRadius: 5 }, reminderOptionCopy: { flex: 1, alignItems: "flex-start" }, reminderOptionTitle: { fontSize: 13, fontWeight: "800" as any }, reminderOptionSubtitle: { fontSize: 10, marginTop: 3 },
});
