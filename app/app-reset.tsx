...
const styles = StyleSheet.create({
  header: { height: 76, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 12, borderBottomWidth: 1 }, back: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerCopy: { flex: 1, alignItems: "flex-start" }, headerTitle: { fontSize: 18, fontWeight: "800" as any }, headerSubtitle: { fontSize: 11, marginTop: 2, textAlign: "left" }, content: { padding: 16, paddingBottom: 36 }, notice: { borderRadius: 18, borderWidth: 1, padding: 14, flexDirection: "row", gap: 10, alignItems: "flex-start" }, noticeIcon: { width: 42, height: 42, borderRadius: 13, alignItems: "center", justifyContent: "center" }, noticeCopy: { flex: 1, alignItems: "flex-start" }, noticeTitle: { fontSize: 14, fontWeight: "800" as any, textAlign: "left" }, noticeText: { fontSize: 11, lineHeight: 18, textAlign: "left", marginTop: 3 }, sectionTitle: { fontSize: 12, fontWeight: "800" as any, textAlign: "left", marginTop: 18, marginBottom: 9, marginRight: 4 }, scope: { minHeight: 81, borderRadius: 17, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 11, flexDirection: "row", gap: 10, alignItems: "center" }, scopeIcon: { width: 42, height: 42, borderRadius: 13, alignItems: "center", justifyContent: "center" }, scopeCopy: { flex: 1, alignItems: "flex-start" }, scopeTitle: { fontSize: 13, fontWeight: "800" as any, textAlign: "left" }, scopeDescription: { fontSize: 10, lineHeight: 15, marginTop: 3, textAlign: "left" }, dependencyTag: { marginTop: 6, borderRadius: 8, paddingHorizontal: 7, paddingVertical: 3, flexDirection: "row", alignItems: "center", gap: 3 }, dependencyText: { fontSize: 9, fontWeight: "700" as any }, gap: { height: 9 }, backdrop: { flex: 1, backgroundColor: "#00000066", justifyContent: "center", padding: 16 }, dialog: { borderRadius: 22, padding: 20, alignItems: "center" }, dialogIcon: { width: 56, height: 56, borderRadius: 18, alignItems: "center", justifyContent: "center" }, dialogTitle: { fontSize: 17, fontWeight: "800" as any, textAlign: "center", marginTop: 11 }, dialogText: { fontSize: 12, lineHeight: 19, textAlign: "center", marginTop: 9 }, backupPromise: { width: "100%", marginTop: 13, borderWidth: 1, borderRadius: 12, padding: 10, flexDirection: "row", justifyContent: "center", alignItems: "center", gap: 6 }, backupPromiseText: { fontSize: 10, fontWeight: "700" as any }, passwordInput: { width: "100%", minHeight: 48, borderRadius: 13, borderWidth: 1, paddingHorizontal: 13, marginTop: 16 }, passwordError: { width: "100%", minHeight: 17, marginTop: 4, fontSize: 10, textAlign: "left" }, actions: { width: "100%", flexDirection: "row", gap: 9, marginTop: 5 }, cancel: { flex: 1, minHeight: 47, borderRadius: 13, borderWidth: 1, alignItems: "center", justifyContent: "center" }, cancelText: { fontSize: 13, fontWeight: "700" as any }, resetButton: { flex: 1.4, minHeight: 47, borderRadius: 13, flexDirection: "row", gap: 6, alignItems: "center", justifyContent: "center" }, resetText: { color: "#fff", fontSize: 12, fontWeight: "800" as any },
});
