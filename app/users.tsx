...
const styles = StyleSheet.create({
  header: { height: 76, flexDirection: "row", alignItems: "center", gap: 12, paddingHorizontal: 16, borderBottomWidth: 1 }, roundButton: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerText: { flex: 1, alignItems: "flex-end" }, headerTitle: { fontSize: 18, fontWeight: "800" as any }, headerSubtitle: { fontSize: 11, marginTop: 2 }, list: { padding: 16, gap: 10, paddingBottom: 34 }, infoCard: { borderWidth: 1, borderRadius: 14, padding: 13, flexDirection: "row", gap: 10, alignItems: "flex-start", marginBottom: 4 }, infoText: { flex: 1, fontSize: 12, lineHeight: 19, textAlign: "right" }, userCard: { borderRadius: 16, borderWidth: 1, padding: 13, flexDirection: "row", alignItems: "center", gap: 11 }, avatar: { width: 44, height: 44, borderRadius: 15, alignItems: "center", justifyContent: "center" }, avatarText: { fontSize: 18, fontWeight: "800" as any }, userInfo: { flex: 1, alignItems: "flex-end" }, userName: { fontSize: 14, fontWeight: "800" as any }, userHandle: { fontSize: 11, marginTop: 4, textAlign: "right" }, userActions: { gap: 7, alignItems: "center" }, locked: { flex: 1, alignItems: "center", justifyContent: "center", gap: 12 }, lockedTitle: { fontSize: 16, fontWeight: "800" as any }, backText: { fontSize: 14, fontWeight: "700" as any }, modalOverlay: { flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(15,23,42,0.45)" }, formSheet: { maxHeight: "94%", borderTopLeftRadius: 24, borderTopRightRadius: 24, overflow: "hidden" }, sheetHeader: { height: 62, paddingHorizontal: 18, alignItems: "center", justifyContent: "space-between", flexDirection: "row" }, sheetTitle: { fontSize: 16, fontWeight: "800" as any }, cancel: { fontSize: 14, fontWeight: "700" as any }, formContent: { paddingHorizontal: 18, paddingBottom: 32 }, label: { fontSize: 13, fontWeight: "700" as any, textAlign: "right", marginTop: 12, marginBottom: 6 }, input: { borderWidth: 1, borderRadius: 12, minHeight: 48, paddingHorizontal: 12, fontSize: 14 }, roleGrid: { gap: 8 }, roleOption: { borderWidth: 1, borderRadius: 13, padding: 11, flexDirection: "row", gap: 9, alignItems: "center" }, roleText: { flex: 1, alignItems: "flex-end" }, roleTitle: { fontSize: 13, fontWeight: "800" as any }, roleDescription: { fontSize: 10, textAlign: "right", marginTop: 2 }, customHeader: { borderTopWidth: 1, borderBottomWidth: 1, marginTop: 16, paddingVertical: 10, flexDirection: "row", alignItems: "center", gap: 10 }, customText: { flex: 1, alignItems: "flex-end" }, customTitle: { fontSize: 13, fontWeight: "800" as any }, customSubtitle: { fontSize: 10, textAlign: "right", marginTop: 2 }, permissionsCard: { marginTop: 10, borderWidth: 1, borderRadius: 13, overflow: "hidden" }, permissionRow: { minHeight: 48, borderBottomWidth: StyleSheet.hairlineWidth, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", gap: 10 }, permissionTitle: { flex: 1, textAlign: "right", fontSize: 12, fontWeight: "700" as any }, saveButton: { marginTop: 20, minHeight: 52, borderRadius: 14, alignItems: "center", justifyContent: "center" }, saveText: { color: "#fff", fontSize: 15, fontWeight: "800" as any },
});
