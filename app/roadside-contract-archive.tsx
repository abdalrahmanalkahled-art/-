...
const styles = StyleSheet.create({
  header: { minHeight: 73, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 9, borderBottomWidth: StyleSheet.hairlineWidth }, back: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerCopy: { flex: 1, alignItems: "flex-start" }, title: { fontSize: 17, fontWeight: "800" as any }, subtitle: { fontSize: 10, marginTop: 3 }, typeTabs: { flexDirection: "row", gap: 8, paddingHorizontal: 16, paddingTop: 14, paddingBottom: 9 }, typeTab: { flex: 1, minHeight: 39, borderRadius: 11, borderWidth: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 5 }, typeText: { fontSize: 11, fontWeight: "800" as any }, list: { padding: 16, gap: 9, paddingBottom: 28 }, emptyList: { flexGrow: 1, justifyContent: "center", padding: 24 }, card: { minHeight: 96, borderWidth: 1, borderRadius: 16, padding: 13, flexDirection: "row", gap: 10, alignItems: "center" }, icon: { width: 46, height: 46, borderRadius: 15, alignItems: "center", justifyContent: "center" }, copy: { flex: 1, alignItems: "flex-start" }, cardTitleRow: { width: "100%", flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 }, cardTitle: { flex: 1, fontSize: 13, fontWeight: "800" as any, textAlign: "left" }, status: { borderRadius: 8, paddingHorizontal: 7, paddingVertical: 3 }, statusText: { fontSize: 9, fontWeight: "800" as any }, cardMeta: { marginTop: 5, fontSize: 10, textAlign: "left" }, cardHint: { marginTop: 4, fontSize: 9, textAlign: "left" }, empty: { alignItems: "center", gap: 8 }, emptyTitle: { fontSize: 15, fontWeight: "800" as any }, emptyText: { maxWidth: 260, textAlign: "center", fontSize: 11, lineHeight: 18 },
});
