...
const styles = StyleSheet.create({
  header: { height: 76, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 12, borderBottomWidth: 1 }, back: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerCopy: { flex: 1, alignItems: "flex-end" }, headerTitle: { fontSize: 18, fontWeight: "800" as any }, headerSubtitle: { fontSize: 11, marginTop: 2 }, content: { padding: 16, paddingBottom: 42 }, loading: { minHeight: 280, alignItems: "center", justifyContent: "center", gap: 12 }, loadingText: { fontSize: 13 }, summary: { minHeight: 104, borderRadius: 20, padding: 18, flexDirection: "row", alignItems: "center", gap: 14, borderWidth: 1 }, summaryCopy: { flex: 1, alignItems: "flex-end" }, summaryValue: { color: "#fff", fontSize: 25, fontWeight: "900" as any }, summaryLabel: { color: "rgba(255,255,255,0.82)", fontSize: 11, marginTop: 4, textAlign: "right" }, metrics: { flexDirection: "row", gap: 10, marginTop: 12 }, metric: { flex: 1, borderWidth: 1, borderRadius: 15, minHeight: 77, padding: 12, alignItems: "flex-end", justifyContent: "center" }, metricValue: { fontSize: 14, fontWeight: "800" as any }, metricLabel: { fontSize: 10, marginTop: 5 }, free: { fontSize: 11, textAlign: "right", marginTop: 9 }, sectionTitle: { fontSize: 12, fontWeight: "800" as any, textAlign: "right", marginTop: 20, marginBottom: 7, marginRight: 4 }, card: { borderWidth: 1, borderRadius: 17, overflow: "hidden" }, bucket: { paddingHorizontal: 14, paddingVertical: 11, gap: 8 }, bucketLink: { backgroundColor: "rgba(37,99,235,0.025)" }, bucketTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, bucketLabel: { flexDirection: "row", alignItems: "center", gap: 7 }, bucketTitle: { fontSize: 13, fontWeight: "700" as any }, bucketMeta: { alignItems: "flex-start" }, bucketSize: { fontSize: 12, fontWeight: "800" as any }, bucketFiles: { fontSize: 10, marginTop: 2 }, track: { height: 6, borderRadius: 4, overflow: "hidden", direction: "ltr" }, fill: { height: "100%", borderRadius: 4 }, empty: { textAlign: "center", fontSize: 12, padding: 22 }, action: { minHeight: 78, flexDirection: "row", alignItems: "center", gap: 11, paddingHorizontal: 13 }, actionIcon: { width: 42, height: 42, borderRadius: 13, alignItems: "center", justifyContent: "center" }, actionCopy: { flex: 1, alignItems: "flex-end" }, actionTitle: { fontSize: 13, fontWeight: "800" as any, textAlign: "right" }, actionSubtitle: { fontSize: 10, textAlign: "right", lineHeight: 15, marginTop: 3 }, note: { fontSize: 11, textAlign: "right", lineHeight: 18, marginTop: 12, paddingHorizontal: 5 },
});
