...
const styles = StyleSheet.create({
  page: { flex: 1 }, header: { minHeight: 73, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 12, borderBottomWidth: StyleSheet.hairlineWidth }, back: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerCopy: { flex: 1, alignItems: "flex-end" }, title: { fontSize: 17, fontWeight: "800" as any }, subtitle: { fontSize: 10, marginTop: 3 }, list: { padding: 16, paddingBottom: 32 }, hero: { borderRadius: 22, padding: 17, marginBottom: 12 }, heroTop: { flexDirection: "row-reverse", gap: 11, alignItems: "center" }, heroIcon: { width: 48, height: 48, borderRadius: 16, backgroundColor: "rgba(255,255,255,0.18)", alignItems: "center", justifyContent: "center" }, heroCopy: { flex: 1, alignItems: "flex-end" }, heroEyebrow: { color: "rgba(255,255,255,0.78)", fontSize: 10, fontWeight: "700" as any }, heroTitle: { color: "#fff", fontSize: 18, fontWeight: "800" as any, textAlign: "right", marginTop: 2 }, heroDates: { color: "rgba(255,255,255,0.84)", fontSize: 10, marginTop: 4 }, heroMetrics: { flexDirection: "row-reverse", marginTop: 15, paddingTop: 13, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.22)" }, heroMetric: { flex: 1, alignItems: "center" }, heroMetricValue: { color: "#fff", fontSize: 16, fontWeight: "900" as any }, heroMetricLabel: { color: "rgba(255,255,255,0.8)", fontSize: 9, marginTop: 4 }, heroDivider: { width: 1, height: 32, backgroundColor: "rgba(255,255,255,0.22)" }, contractStateBadge: { minWidth: 56, minHeight: 29, paddingHorizontal: 8, borderRadius: 10, borderWidth: 1, backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center" }, contractStateText: { fontSize: 13, fontWeight: "900" as any }, overview: { borderWidth: 1, borderRadius: 16, paddingHorizontal: 13, marginBottom: 12 }, overviewRow: { minHeight: 56, flexDirection: "row-reverse", alignItems: "center", gap: 9 }, overviewCopy: { flex: 1, alignItems: "flex-end" }, overviewValue: { fontSize: 12, fontWeight: "800" as any, textAlign: "right" }, overviewLabel: { fontSize: 9, marginTop: 3 }, overviewLine: { height: StyleSheet.hairlineWidth }, ratingsSummary: { borderWidth: 1, borderRadius: 16, padding: 12, marginBottom: 16 }, ratingsHeading: { flexDirection: "row-reverse", alignItems: "center", gap: 6, justifyContent: "flex-end" }, ratingsTitle: { fontSize: 12, fontWeight: "800" as any }, ratingChips: { flexDirection: "row-reverse", gap: 7, marginTop: 10, flexWrap: "wrap" }, ratingChip: { minWidth: 54, minHeight: 45, borderWidth: 1, borderRadius: 11, alignItems: "center", justifyContent: "center", paddingHorizontal: 9 }, ratingChipValue: { fontSize: 14, fontWeight: "900" as any }, ratingChipLabel: { fontSize: 9, fontWeight: "800" as any, marginTop: 1 }, boardHeading: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }, boardHeadingTitle: { fontSize: 15, fontWeight: "800" as any }, boardCount: { fontSize: 11, fontWeight: "800" as any }, boardCard: { borderWidth: 1, borderRadius: 17, overflow: "hidden", marginBottom: 10 }, imagesRow: { flexDirection: "row-reverse", gap: 1 }, boardImageTouch: { flex: 1, height: 152 }, boardImage: { width: "100%", height: 152 }, boardImagePlaceholder: { flex: 1, height: 102, alignItems: "center", justifyContent: "center", gap: 5 }, missingFace: { fontSize: 9, textAlign: "center", paddingHorizontal: 8 }, imageLabel: { position: "absolute", bottom: 6, alignSelf: "center", backgroundColor: "rgba(0,0,0,0.62)", borderRadius: 10, paddingHorizontal: 7, paddingVertical: 4, flexDirection: "row-reverse", alignItems: "center", gap: 4 }, imageLabelText: { color: "#fff", fontSize: 9, fontWeight: "700" as any }, boardBody: { padding: 12 }, boardTop: { flexDirection: "row-reverse", alignItems: "center", gap: 8 }, boardNumber: { width: 30, height: 30, borderRadius: 10, alignItems: "center", justifyContent: "center" }, boardNumberText: { fontSize: 12, fontWeight: "900" as any }, boardTitleCopy: { flex: 1, alignItems: "flex-end" }, boardTitle: { fontSize: 13, fontWeight: "800" as any }, boardRegion: { fontSize: 10, marginTop: 3 }, boardInfoGrid: { flexDirection: "row-reverse", gap: 8, marginTop: 11, flexWrap: "wrap" }, boardInfo: { minHeight: 30, paddingHorizontal: 7, maxWidth: "48%", flexDirection: "row-reverse", justifyContent: "center", alignItems: "center", gap: 4 }, boardInfoText: { fontSize: 10, textAlign: "right", flexShrink: 1 }, address: { marginTop: 9, paddingTop: 9, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: "row-reverse", gap: 5, alignItems: "flex-start" }, addressText: { flex: 1, fontSize: 10, textAlign: "right", lineHeight: 15 }, viewerBackdrop: { flex: 1, justifyContent: "center", padding: 18, backgroundColor: "rgba(0,0,0,0.72)" }, viewer: { borderRadius: 22, overflow: "hidden", maxHeight: "88%" }, viewerHeader: { minHeight: 56, paddingHorizontal: 13, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, viewerClose: { width: 36, height: 36, borderRadius: 18, alignItems: "center", justifyContent: "center" }, viewerTitle: { fontSize: 14, fontWeight: "800" as any, textAlign: "right" }, fullImage: { height: 480, width: "100%" }, empty: { flex: 1, alignItems: "center", justifyContent: "center", padding: 24, gap: 8 }, emptyTitle: { fontSize: 15, fontWeight: "800" as any }, emptyText: { fontSize: 11, textAlign: "center" },
});
