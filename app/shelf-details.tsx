...
const styles = StyleSheet.create({
  ...
  heroTop: { flexDirection: "row-reverse", gap: 11, alignItems: "center" },
  ...
  heroMetrics: { flexDirection: "row-reverse", marginTop: 15, paddingTop: 13, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.22)" },
  ...
  overviewRow: { minHeight: 56, flexDirection: "row-reverse", alignItems: "center", gap: 9 },
  ...
  imageLabel: { position: "absolute", bottom: 10, alignSelf: "center", backgroundColor: "rgba(0,0,0,0.62)", borderRadius: 10, paddingHorizontal: 9, paddingVertical: 5, flexDirection: "row-reverse", alignItems: "center", gap: 4 },
  ...
  allocationsHeading: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", marginBottom: 10 },
  allocationCount: { fontSize: 11, fontWeight: "800" as any },
  allocationCard: { minHeight: 78, borderWidth: 1, borderRadius: 17, marginBottom: 9, paddingHorizontal: 12, flexDirection: "row-reverse", alignItems: "center", gap: 9 },
  ...
  notesHeader: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "flex-end", gap: 7 },
