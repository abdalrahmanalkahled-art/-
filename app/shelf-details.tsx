...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 10, marginTop: 3, textAlign: "left" },
  ...
  heroTitle: { color: "#fff", fontSize: 18, fontWeight: "800" as any, textAlign: "left", marginTop: 2 },
  heroDates: { color: "rgba(255,255,255,0.84)", fontSize: 10, marginTop: 4, textAlign: "left" },
  ...
  overviewCopy: { flex: 1, alignItems: "flex-start" },
  overviewValue: { fontSize: 12, fontWeight: "800" as any, textAlign: "left" },
  overviewLabel: { fontSize: 9, marginTop: 3 },
  overviewLine: { height: StyleSheet.hairlineWidth },
  sectionTitle: { fontSize: 15, fontWeight: "800" as any, textAlign: "left", marginBottom: 10 },
  ...
  allocationCopy: { flex: 1, alignItems: "flex-start" },
  allocationBrand: { fontSize: 14, fontWeight: "800" as any, textAlign: "left" },
  allocationHint: { fontSize: 10, marginTop: 3, textAlign: "left" },
  ...
  notesHeader: { flexDirection: "row", alignItems: "center", justifyContent: "flex-start", gap: 7 },
  notesTitle: { fontSize: 14, fontWeight: "800" as any },
  notesText: { fontSize: 12, lineHeight: 20, textAlign: "left", marginTop: 10 },
  ...
  viewerTitle: { fontSize: 14, fontWeight: "800" as any, textAlign: "left" },
