...
const styles = StyleSheet.create({
  ...
  hero: { borderRadius: 22, padding: 18, gap: 9 }, heroTopRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, heroIcon: { width: 44, height: 44, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.16)", alignItems: "center", justifyContent: "center" }, heroStatus: { flexDirection: "row", alignItems: "center", gap: 6, borderRadius: 20, paddingHorizontal: 10, paddingVertical: 6 }, statusDot: { width: 7, height: 7, borderRadius: 4 }, heroStatusText: { color: "#fff", fontSize: 12, fontWeight: "800" as const }, heroTitle: { color: "#fff", fontSize: 22, fontWeight: "900" as const, textAlign: "left", lineHeight: 30 }, heroBrand: { flexDirection: "row", alignSelf: "flex-start", alignItems: "center", gap: 5, backgroundColor: "rgba(255,255,255,0.14)", borderRadius: 10, paddingHorizontal: 8, paddingVertical: 4 }, heroBrandText: { color: "#fff", fontSize: 12, fontWeight: "700" as const }, heroPeriod: { color: "rgba(255,255,255,0.83)", fontSize: 12, textAlign: "left" },
  progressCard: { borderRadius: 18, borderWidth: 1, padding: 15, gap: 13 }, sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, sectionTitle: { fontSize: 15, fontWeight: "800" as const, textAlign: "left" }, progressPercent: { fontSize: 16, fontWeight: "900" as const }, statsRow: { flexDirection: "row", borderTopWidth: StyleSheet.hairlineWidth, paddingTop: 13, gap: 6 }, metric: { flex: 1, alignItems: "center", gap: 4, minWidth: 0 }, metricIcon: { width: 30, height: 30, borderRadius: 10, alignItems: "center", justifyContent: "center" }, metricValue: { fontSize: 13, fontWeight: "800" as const, textAlign: "center" }, metricCompactValue: { fontSize: 11 }, metricLabel: { fontSize: 10, textAlign: "center" },
  impactRow: { flexDirection: "row", gap: 10 }, impactMetric: { flex: 1, minHeight: 78, borderRadius: 17, borderWidth: 1, flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 12 }, impactIcon: { width: 38, height: 38, borderRadius: 12, alignItems: "center", justifyContent: "center" }, impactCopy: { flex: 1, alignItems: "flex-start" }, impactValue: { fontSize: 18, fontWeight: "900" as const }, impactLabel: { marginTop: 2, fontSize: 11, fontWeight: "700" as const, textAlign: "left" },
  detailCard: { borderRadius: 18, padding: 15, borderWidth: 1, gap: 8 }, description: { fontSize: 13, lineHeight: 21, textAlign: "left" }, sectionHeading: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 5 }, sectionCount: { minWidth: 24, textAlign: "center", fontSize: 12, fontWeight: "800" as const },
  taskCard: { minHeight: 67, borderRadius: 15, borderWidth: 1, flexDirection: "row", overflow: "hidden" }, taskStripe: { width: 4 }, taskCopy: { flex: 1, padding: 11, gap: 6 }, taskTopRow: { flexDirection: "row", alignItems: "center", gap: 9 }, taskTitle: { flex: 1, fontSize: 13, fontWeight: "800" as const, textAlign: "left" }, taskBadge: { borderRadius: 9, paddingHorizontal: 7, paddingVertical: 4 }, taskBadgeText: { fontSize: 10, fontWeight: "800" as const }, taskMeta: { fontSize: 11, textAlign: "left" },
  eventCard: { borderRadius: 17, borderWidth: 1, padding: 13, gap: 11 }, eventTopRow: { flexDirection: "row", alignItems: "center", gap: 9 }, eventIcon: { width: 38, height: 38, borderRadius: 12, alignItems: "center", justifyContent: "center" }, eventTitleWrap: { flex: 1, alignItems: "flex-start", gap: 2 }, eventTitle: { fontSize: 14, fontWeight: "800" as const, textAlign: "left" }, eventDate: { fontSize: 11, textAlign: "left" }, eventBadge: { borderRadius: 9, paddingHorizontal: 7, paddingVertical: 4 }, eventBadgeText: { fontSize: 10, fontWeight: "800" as const }, eventDivider: { height: StyleSheet.hairlineWidth }, eventMetaRow: { flexDirection: "row", justifyContent: "space-between", gap: 7 }, eventMeta: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "flex-start", gap: 4, minWidth: 0 }, eventMetaText: { flex: 1, fontSize: 10, textAlign: "left" },
