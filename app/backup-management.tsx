...
const restoreHistoryStyles = StyleSheet.create({
  shortcut: { position: "absolute", left: 16, right: 16, bottom: 18, minHeight: 62, borderRadius: 16, borderWidth: 1, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", gap: 9 }, shortcutIcon: { width: 38, height: 38, borderRadius: 12, alignItems: "center", justifyContent: "center" }, shortcutCopy: { flex: 1, alignItems: "flex-start" }, shortcutTitle: { fontSize: 12, fontWeight: "800" as any, textAlign: "left" }, shortcutMeta: { fontSize: 9, marginTop: 3, textAlign: "left" }, dialog: { maxHeight: "84%", width: "100%", borderRadius: 22, padding: 18 }, dialogHeader: { flexDirection: "row", alignItems: "center", gap: 10 }, close: { width: 34, height: 34, borderRadius: 11, alignItems: "center", justifyContent: "center" }, dialogHeaderCopy: { flex: 1, alignItems: "flex-start" }, dialogTitle: { fontSize: 17, fontWeight: "800" as any, textAlign: "left" }, dialogSubtitle: { fontSize: 10, marginTop: 3, textAlign: "left" }, source: { marginTop: 14, padding: 12, borderRadius: 14, borderWidth: 1, alignItems: "flex-start" }, sourceLabel: { fontSize: 9 }, sourceValue: { fontSize: 12, fontWeight: "800" as any, marginTop: 3, textAlign: "left" }, sourceMeta: { fontSize: 10, marginTop: 5, textAlign: "left" }, stats: { flexDirection: "row", marginTop: 13 }, stat: { flex: 1, alignItems: "center" }, statValue: { fontSize: 19, fontWeight: "900" as any }, statLabel: { fontSize: 9, marginTop: 3, textAlign: "center" }, settingsNote: { fontSize: 10, textAlign: "center", marginTop: 12 }, groupsTitle: { fontSize: 12, fontWeight: "800" as any, textAlign: "left", marginTop: 14 }, groupList: { maxHeight: 240, marginTop: 5 }, groupListContent: { paddingBottom: 4 }, groupRow: { minHeight: 53, borderBottomWidth: StyleSheet.hairlineWidth, paddingVertical: 8, flexDirection: "row", alignItems: "center", gap: 9 }, groupCopy: { flex: 1, alignItems: "flex-start" }, groupTitle: { fontSize: 12, fontWeight: "800" as any, textAlign: "left" }, groupMeta: { fontSize: 9, marginTop: 3, textAlign: "left" }, closeButton: { minHeight: 46, borderRadius: 13, alignItems: "center", justifyContent: "center", marginTop: 12 }, closeButtonText: { color: "#fff", fontSize: 13, fontWeight: "800" as any },
});

const styles = StyleSheet.create({
  header: { height: 76, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 12, borderBottomWidth: 1 }, back: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerCopy: { flex: 1, alignItems: "flex-start" }, headerTitle: { fontSize: 18, fontWeight: "800" as any }, headerSubtitle: { fontSize: 11, marginTop: 2, textAlign: "left" }, headerAction: { padding: 6 }, headerActionText: { fontSize: 13, fontWeight: "700" as any }, selectionHeaderActions: { flexDirection: "row", alignItems: "center", gap: 3 }, selectionHeaderAction: { width: 46, height: 46, borderRadius: 13, borderWidth: 1, alignItems: "center", justifyContent: "center", gap: 1 }, selectionHeaderActionText: { fontSize: 8, fontWeight: "700" as any }, content: { padding: 16, paddingBottom: 106 }, summary: { minHeight: 102, borderRadius: 20, padding: 18, flexDirection: "row", alignItems: "center", gap: 14, borderWidth: 1 }, summaryCopy: { flex: 1, alignItems: "flex-start" }, summaryValue: { color: "#fff", fontSize: 25, fontWeight: "900" as any }, summaryLabel: { color: "rgba(255,255,255,0.82)", fontSize: 11, marginTop: 4, textAlign: "left" }, actions: { marginTop: 12, gap: 9 }, primaryAction: { minHeight: 50, borderRadius: 15, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }, primaryActionText: { color: "#fff", fontSize: 14, fontWeight: "800" as any }, secondaryActions: { flexDirection: "row", gap: 9 }, secondaryAction: { flex: 1, minHeight: 48, borderRadius: 14, borderWidth: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6 }, secondaryActionText: { fontSize: 12, fontWeight: "700" as any }, hint: { fontSize: 11, lineHeight: 17, textAlign: "left", marginTop: 12, marginBottom: 14 }, backupRow: { minHeight: 88, borderRadius: 17, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 11, flexDirection: "row", alignItems: "center", gap: 10 }, fileIcon: { width: 45, height: 45, borderRadius: 14, alignItems: "center", justifyContent: "center" }, backupCopy: { flex: 1, alignItems: "flex-start" }, backupTitle: { fontSize: 13, fontWeight: "800" as any, textAlign: "left" }, backupName: { fontSize: 10, marginTop: 3, textAlign: "left" }, backupMeta: { fontSize: 10, marginTop: 4, textAlign: "left" }, check: { width: 23, height: 23, borderRadius: 7, borderWidth: 1.5, alignItems: "center", justifyContent: "center" }, gap: { height: 9 }, empty: { minHeight: 210, borderRadius: 18, borderWidth: 1, alignItems: "center", justifyContent: "center", gap: 10, padding: 24 }, emptyText: { fontSize: 12, textAlign: "center", lineHeight: 19 }, loading: { minHeight: 220, alignItems: "center", justifyContent: "center" }, selectionBar: { position: "absolute", left: 0, right: 0, bottom: 0, flexDirection: "row", gap: 10, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 18, borderTopWidth: 1 }, selectionButton: { flex: 1, minHeight: 48, borderRadius: 14, borderWidth: 1, alignItems: "center", justifyContent: "center" }, selectionButtonText: { fontSize: 13, fontWeight: "700" as any }, deleteButton: { flex: 1.25, minHeight: 48, borderRadius: 14, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7 }, deleteButtonText: { color: "#fff", fontSize: 13, fontWeight: "800" as any }, modalBackdrop: { flex: 1, backgroundColor: "#00000066", justifyContent: "center", padding: 16 }, sectionDialog: { maxHeight: "86%", borderRadius: 22, overflow: "hidden" }, dialogHeader: { minHeight: 74, flexDirection: "row", alignItems: "center", gap: 12, paddingHorizontal: 16 }, dialogHeaderCopy: { flex: 1, alignItems: "flex-start" }, dialogTitle: { fontSize: 17, fontWeight: "800" as any }, dialogSubtitle: { fontSize: 11, marginTop: 3 }, sectionList: { maxHeight: 410 }, sectionChoice: { minHeight: 70, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", gap: 11, borderBottomWidth: StyleSheet.hairlineWidth }, choiceCheck: { width: 22, height: 22, borderRadius: 7, borderWidth: 1.5, alignItems: "center", justifyContent: "center" }, choiceCopy: { flex: 1, alignItems: "flex-start" }, choiceTitle: { fontSize: 13, fontWeight: "800" as any, textAlign: "left" }, choiceDescription: { fontSize: 10, marginTop: 3, textAlign: "left" }, createPartialButton: { minHeight: 52, margin: 14, borderRadius: 15, alignItems: "center", justifyContent: "center" }, createPartialText: { color: "#fff", fontSize: 14, fontWeight: "800" as any }, passwordDialog: { borderRadius: 22, padding: 20, alignItems: "center" }, passwordIcon: { width: 54, height: 54, borderRadius: 17, alignItems: "center", justifyContent: "center" }, passwordTitle: { fontSize: 18, fontWeight: "800" as any, marginTop: 12 }, passwordMessage: { fontSize: 12, textAlign: "center", lineHeight: 19, marginTop: 8 }, passwordInput: { width: "100%", height: 48, borderWidth: 1, borderRadius: 13, paddingHorizontal: 13, marginTop: 16 }, passwordError: { minHeight: 18, alignSelf: "flex-start", fontSize: 11, marginTop: 4 }, passwordActions: { flexDirection: "row", gap: 9, width: "100%", marginTop: 8 }, cancelButton: { flex: 1, height: 47, borderRadius: 13, borderWidth: 1, alignItems: "center", justifyContent: "center" }, cancelButtonText: { fontSize: 13, fontWeight: "700" as any }, confirmDeleteButton: { flex: 1.2, height: 47, borderRadius: 13, alignItems: "center", justifyContent: "center" }, confirmDeleteText: { color: "#fff", fontSize: 13, fontWeight: "800" as any }, restoreDialog: { borderRadius: 22, padding: 20, alignItems: "center" }, restoreIcon: { width: 56, height: 56, borderRadius: 18, alignItems: "center", justifyContent: "center" }, restoreTitle: { fontSize: 18, fontWeight: "800" as any, marginTop: 11 }, restoreMeta: { fontSize: 10, marginTop: 4, textAlign: "center" }, restoreModes: { width: "100%", gap: 8, marginTop: 16 }, restoreMode: { minHeight: 76, width: "100%", paddingHorizontal: 11, borderRadius: 15, borderWidth: 1, flexDirection: "row", alignItems: "center", gap: 9 }, restoreModeIcon: { width: 36, height: 36, borderRadius: 11, alignItems: "center", justifyContent: "center" }, restoreModeCopy: { flex: 1, alignItems: "flex-start" }, restoreModeTitle: { fontSize: 13, fontWeight: "800" as any, textAlign: "left" }, restoreModeText: { fontSize: 10, lineHeight: 15, marginTop: 2, textAlign: "left" }, radio: { width: 18, height: 18, borderRadius: 9, borderWidth: 1.5, alignItems: "center", justifyContent: "center" }, radioDot: { width: 9, height: 9, borderRadius: 5 }, restoreDescription: { fontSize: 11, lineHeight: 17, textAlign: "center", marginTop: 12 }, mergePreview: { width: "100%", marginTop: 12, borderRadius: 15, borderWidth: 1, padding: 12 }, mergePreviewTitle: { fontSize: 12, fontWeight: "800" as any, textAlign: "left" }, mergeStats: { flexDirection: "row", justifyContent: "space-between", marginTop: 9 }, mergeStat: { flex: 1, alignItems: "center" }, mergeStatValue: { fontSize: 18, fontWeight: "900" as any }, mergeStatLabel: { fontSize: 9, marginTop: 2 }, settingsNote: { fontSize: 10, lineHeight: 15, textAlign: "center", marginTop: 10 }, restoreActions: { flexDirection: "row", gap: 9, width: "100%", marginTop: 14 }, restoreConfirmButton: { flex: 1.3, height: 47, borderRadius: 13, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 6 }, restoreConfirmText: { color: "#fff", fontSize: 12, fontWeight: "800" as any },
});
