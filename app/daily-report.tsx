...
export default function DailyReportScreen() {
  ...
  const exportReport = async () => {
    if (!report) return;
    setIsExporting(true);
    try { await exportDailyReportPdf(report, { includeMedia }); }
  ...
  return <ScreenContainer containerClassName="bg-background">
    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
      ...
      <View style={[styles.reportOutline, { backgroundColor: colors.surface, borderColor: colors.border }]}><Text style={[styles.outlineTitle, { color: colors.foreground }]}>ما الذي سيظهر في التقرير؟</Text><Text style={[styles.outlineText, { color: colors.muted }]}>{includeMedia ? "معلومات عامة للفترة، مؤشرات الزيارات، ثم تفاصيل كل محل مع صور الاستبيان والمنتجات والإجابات والملاحظات، ثم الفعاليات، وأخيراً ملخص تنفيذي مختصر." : "معلومات عامة للفترة، مؤشرات الزيارات، ثم تفاصيل كل محل مع المنتجات والإجابات والملاحظات، ثم الفعاليات، وأخيراً ملخص تنفيذي مختصر."}</Text></View>
...
const styles = StyleSheet.create({
  header: { height: 76, flexDirection: "row", gap: 12, alignItems: "center", paddingHorizontal: 16, borderBottomWidth: 1 }, roundButton: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" }, headerText: { flex: 1, alignItems: "flex-start" }, headerTitle: { fontSize: 18, fontWeight: "800" as any }, headerSubtitle: { fontSize: 11, marginTop: 2 }, content: { padding: 16, paddingBottom: 38 }, hero: { borderWidth: 1, borderRadius: 16, padding: 15, flexDirection: "row", gap: 12, alignItems: "flex-start" }, heroText: { flex: 1, alignItems: "flex-start" }, heroTitle: { fontSize: 14, fontWeight: "800" as any, textAlign: "left" }, heroSubtitle: { fontSize: 11, lineHeight: 18, textAlign: "left", marginTop: 4 }, sectionTitle: { fontSize: 15, fontWeight: "800" as any, textAlign: "left", marginTop: 20, marginBottom: 10 }, presets: { flexDirection: "row", gap: 8, justifyContent: "flex-start" }, preset: { flex: 1, minHeight: 38, borderWidth: 1, borderRadius: 11, alignItems: "center", justifyContent: "center" }, presetText: { fontSize: 12, fontWeight: "700" as any }, rangeCard: { borderWidth: 1, borderRadius: 14, padding: 12, marginTop: 10, flexDirection: "row", alignItems: "center", gap: 8 }, dateField: { flex: 1, alignItems: "flex-start" }, dateLabel: { fontSize: 11, marginBottom: 4 }, dateValue: { fontSize: 13, fontWeight: "800" as any }, updateButton: { alignSelf: "center", flexDirection: "row", borderWidth: 1, borderRadius: 11, paddingHorizontal: 12, paddingVertical: 8, gap: 6, marginTop: 10 }, updateText: { fontSize: 12, fontWeight: "700" as any }, loading: { height: 100, alignItems: "center", justifyContent: "center" }, metrics: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, metric: { width: "31%", borderWidth: 1, borderRadius: 14, padding: 10, alignItems: "center" }, metricIcon: { width: 32, height: 32, borderRadius: 10, justifyContent: "center", alignItems: "center" }, metricValue: { fontSize: 18, fontWeight: "800" as any, marginTop: 5 }, metricLabel: { fontSize: 10, textAlign: "center", marginTop: 2 }, regionsCard: { marginTop: 10, borderWidth: 1, borderRadius: 14, padding: 13, alignItems: "flex-start" }, regionsTitle: { fontSize: 13, fontWeight: "800" as any }, regionsText: { fontSize: 12, textAlign: "left", marginTop: 5 }, mediaSetting: { borderWidth: 1, borderRadius: 14, padding: 12, flexDirection: "row", alignItems: "center", gap: 10 }, mediaSettingCopy: { flex: 1, alignItems: "flex-start" }, mediaSettingTitle: { fontSize: 13, fontWeight: "800" as any }, mediaSettingSubtitle: { fontSize: 10, textAlign: "left", marginTop: 4 }, mediaOptions: { height: 38, borderRadius: 11, padding: 3, flexDirection: "row" }, mediaOption: { minWidth: 74, borderRadius: 8, borderWidth: 1, borderColor: "transparent", alignItems: "center", justifyContent: "center", paddingHorizontal: 6 }, mediaOptionText: { fontSize: 9, fontWeight: "800" as any }, reportOutline: { marginTop: 16, borderWidth: 1, borderRadius: 14, padding: 13, alignItems: "flex-start" }, outlineTitle: { fontSize: 13, fontWeight: "800" as any }, outlineText: { fontSize: 11, lineHeight: 19, textAlign: "left", marginTop: 5 }, exportButton: { minHeight: 54, marginTop: 20, borderRadius: 15, justifyContent: "center", alignItems: "center", flexDirection: "row", gap: 8 }, exportText: { color: "#fff", fontSize: 15, fontWeight: "800" as any },
});
