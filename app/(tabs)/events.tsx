...
const styles = StyleSheet.create({
  ...
  eventCardHeader: { flexDirection: "row", alignItems: "center", justifyContent: "flex-start", gap: 10, marginBottom: 10 },
  eventTitle: { fontSize: 15, fontWeight: "700" as any, flex: 1, textAlign: "left" },
  statusBadge: { borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3 },
  statusText: { fontSize: 12, fontWeight: "600" as any },
  eventMeta: { flexDirection: "row", justifyContent: "flex-start", gap: 16, marginBottom: 10 },
  ...
  goalSelectorHeaderCopy: { flex: 1, alignItems: "flex-start" as const },
  goalSelectorSubtitle: { marginTop: 3, fontSize: 11, textAlign: "left" as const },
