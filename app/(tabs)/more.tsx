      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.settingsSection, { backgroundColor: colors.surface, borderColor: colors.border }]}> 
          ...
          <TouchableOpacity style={[styles.settingsItem, { borderBottomColor: colors.border }]} onPress={() => router.push("/settings" as any)}>
            <MaterialIcons name="chevron-right" size={20} color={colors.muted} /><Text style={[styles.settingsText, { color: colors.foreground }]}>الإعدادات</Text><MaterialIcons name="settings" size={20} color={colors.primary} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.settingsItem} onPress={() => setShowLogoutConfirmation(true)}>
            <MaterialIcons name="chevron-right" size={20} color={colors.error} /><Text style={[styles.settingsText, { color: colors.error }]}>تسجيل الخروج</Text><MaterialIcons name="logout" size={20} color={colors.error} />
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  modulesSection: { paddingHorizontal: 16, marginBottom: 16 }, sectionTitle: { fontSize: 16, fontWeight: "700" as any, textAlign: "left", marginBottom: 12 }, modulesGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10 }, moduleCard: { width: "47%", borderRadius: 16, padding: 16, borderWidth: 1, alignItems: "center", shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2 }, moduleIcon: { width: 52, height: 52, borderRadius: 14, alignItems: "center", justifyContent: "center", marginBottom: 10 }, moduleTitle: { fontSize: 14, fontWeight: "700" as any, textAlign: "center", marginBottom: 4 }, moduleSubtitle: { fontSize: 11, textAlign: "center" },
  settingsSection: { marginHorizontal: 16, borderRadius: 16, borderWidth: 1, overflow: "hidden", marginBottom: 16 }, settingsItem: { flexDirection: "row", alignItems: "center", padding: 16, borderBottomWidth: StyleSheet.hairlineWidth, gap: 12 }, settingsText: { flex: 1, fontSize: 15, fontWeight: "500" as any, textAlign: "left" }, bottomPadding: { height: 30 },
  transitionCanvas: { flex: 1 }, expandingCard: { position: "absolute", borderWidth: 1, elevation: 14 }, expandingHero: { position: "absolute", alignItems: "center", justifyContent: "center", zIndex: 1 }, expandedPage: { ...StyleSheet.absoluteFillObject }, moduleModalHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 16, borderBottomWidth: StyleSheet.hairlineWidth }, moduleModalTitle: { fontSize: 17, fontWeight: "700" as any }, headerSpacer: { width: 24 }, moduleHero: { minHeight: 76, flexDirection: "row", alignItems: "center", gap: 12, paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: StyleSheet.hairlineWidth }, moduleHeroIcon: { width: 46, height: 46, borderRadius: 15, alignItems: "center", justifyContent: "center" }, moduleHeroText: { flex: 1, alignItems: "flex-start" }, moduleHeroTitle: { fontSize: 16, fontWeight: "800" as any, textAlign: "left" }, moduleHeroSubtitle: { fontSize: 11, marginTop: 3, textAlign: "left" }, moduleCloseButton: { width: 38, height: 38, borderRadius: 19, alignItems: "center", justifyContent: "center" }, moduleContent: { flex: 1 },
});
