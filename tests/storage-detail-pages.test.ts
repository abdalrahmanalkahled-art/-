...
describe("صفحات تفاصيل إدارة مساحة التخزين", () => {
  it("يفتح صور المحلات ووسائط الأصول والقوالب والنسخ الاحتياطية والحزم التحليلية من ملخص المساحة", () => {
    expect(overviewSource).toContain('const DETAIL_BUCKETS: StorageBucketId[] = ["storePhotos", "signageMedia", "templates", "backups", "externalAnalytics"]');
